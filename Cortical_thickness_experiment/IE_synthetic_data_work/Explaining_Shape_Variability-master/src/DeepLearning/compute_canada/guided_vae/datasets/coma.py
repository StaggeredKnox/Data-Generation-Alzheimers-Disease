...
class CoMA(InMemoryDataset): 
    ...
    def process(self):
        ...
        labels = torch.load(f"/home/rajk/Desktop/IE_synthetic_data_work/Explaining_Shape_Variability-master/src/DeepLearning/compute_canada/guided_vae/data/CoMA/raw/torus/labels.pt")
        ...
        X_train, X_test, y_train, y_test = train_test_split(list(labels.keys()), list(labels.values()), test_size=0.2, random_state=28) #xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
        print(X_test)
        print(y_test)
        print(len(X_train))
        #print("ajsdiojasiodjoiasjdioaj")
        #random.seed(3783)
        ...
        #self.raw_dir = "/home/rajk/Desktop/IE_synthetic_data_work/Explaining_Shape_Variability-master/src/DeepLearning/compute_canada/guided_vae/data/CoMA/raw"

        fps = glob(osp.join(self.raw_dir, 'torus/*.npy'))    #xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
        #print(fps)
        '''
        if len(fps) == 0:
        ...
        print("DEKHO VAI :  x    edge_index     face     y")
        ...
        for i in train_data_list:
            su += i.x.shape[0]	
        print(su)
        print(train_data_list[0].x.shape)
        print("xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx")
        print(self.collate(train_data_list))
        print("xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx")
